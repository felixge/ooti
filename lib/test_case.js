(function(testCase) {
	...
	testCase.run = function(testCaseClass) {
		...
		var next = function() {
			...
			if (!step.definition) {
				...
				try {
					var args = step.definition.args.slice();
					args.unshift(testCaseClass);
					step.definition.fn.apply(testCaseClass, args);
	...
	testCase.TestCase.prototype.error = function(error) {
